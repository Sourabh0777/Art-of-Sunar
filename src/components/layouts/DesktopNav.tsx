  ...
  return (
    <div className='hidden lg:flex gap-x-8 items-center'>
      <Link href='/' className='flex space-x-2'>
        ...
        <span className='hidden font-bold lg:inline-block'>Art Of Sunar</span>
                ...
                <li className='row-span-3'>
                  <NavigationMenuLink asChild>
                    <Link className='flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md' href='/'>
                      ...
                      <div className='mb-2 mt-4 text-lg font-medium'>Jewellery Shop </div>
                      <p className='text-sm leading-tight text-muted-foreground'>Elegant jewelry for every occasion, tailored to delight</p>
                    </Link>
                  </NavigationMenuLink>
                </li>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className='grid w-[400px] gap-3 p-6 md:w-[500px] md:grid-cols-2'>
                <ListItem href='/products?category=skateboards' title='Gold'>
                  Explore the Gold jewellery category
                </ListItem>
                <ListItem href='/products?category=clothing' title='Silver'>
                  Explore the Silver jewellery category
                </ListItem>
                <ListItem href='/products?category=shoes' title='Artificial'>
                  Explore the Artificial jewellery category
                </ListItem>
